...
export default function Features() {
  ...
  useEffect(() => {
   ...
   secondRowRefs.current.forEach((box, i) => {
    ...
    return (
        <div className="features-sec w-full h-auto  flex flex-col items-center justify-center py-[15vw] lg:py-[10vw]" id="features">
        <div  className="features w-[95vw] flex flex-col items-center justify-center gap-[3vw]" id="feature">
        <div className="title w-full flex flex-col items-start justify-center">
