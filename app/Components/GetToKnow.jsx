...
export default function Get() {
    ...
    return (
      <div className="w-full h-auto flex items-center justify-center pb-10" id="gettoknow">
          <div className="container w-[95vw] h-auto lg:h-[110vh] xl:h-[95vh] xl:h-auto flex flex-col lg:flex-row items-start justify-between pt-[7vw] ">

            {/* ref={imageRef} */}
          <img  className="w-[70vw] lg:w-[35vw] " src="suk_img2-Recovered.png" alt="app interface" />
