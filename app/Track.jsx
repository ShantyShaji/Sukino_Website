...
export default function Track() {
  ...
  useEffect(() => {
    ...
    return (
        <div className="main w-full flex items-center justify-center h-auto bg-[#DFF5FF]" id="track">
      ...
      <div  className='w-[70vw] lg:w-[40vw] h-auto overflow-hidden'>
       <img ref={imageRef} className='w-full lg:w-[25vw]' src="suk_img3.png" alt="half mobile image " /> 
